...
// intro video for course 183101 ("Product-маркетинг: продукт, аудитория и
// запуск" — free, CAREERSTART funnel into 94834).
  ...
  build: () => {
    ...
    const html = `
      <div class="title-wrap">
        ...
        <h1 class="big" style="color:#fff;">Product-маркетинг: продукт, аудитория и запуск</h1>
        <p class="sub">От идеи и MVP до go-to-market стратегии и метрик успешного запуска.</p>
      </div>
    `;
    ...
    const html = `
      ...
      <div class="avtor-content">
        ...
        <ul class="list-plain" style="margin-top:12px;font-size:13px;">
          ...
          <li>Каждый день работаю на стыке продукта, маркетинга и запуска новых функций</li>
          <li>Курс — практический разбор роли продакт-маркетолога, а не теория без применения</li>
        </ul>
      </div>
    `;
...
slides.push({
  out: 'l03-dlya-kogo',
  build: () => contentSlide('Для кого этот курс', 'Для маркетологов и начинающих продакт-менеджеров', `
    <ul class="list-plain" style="margin-top:14px;max-width:820px;">
      <li>Для маркетологов, которые хотят перейти в продакт-маркетинг</li>
      <li>Для начинающих продакт-менеджеров, которым важна маркетинговая сторона запуска</li>
...
slides.push({
  out: 'l04-programma',
  build: () => contentSlide('Программа курса', 'От идеи и MVP до метрик запуска', stepsNum([
    { h: 'Что такое продакт-маркетинг', p: 'Роль на стыке продукта и маркетинга, JTBD аудитории' },
    { h: 'От идеи к MVP', p: 'Этапы разработки, MVP, PoC, product-market fit' },
    { h: 'Методологии и жизненный цикл', p: 'Agile, Scrum, Kanban и стадии жизни продукта' },
    { h: 'Go-to-market стратегия', p: 'Позиционирование и выбор каналов запуска' },
    { h: 'Метрики и примеры', p: 'Активация, удержание, NPS, кейсы Uber и Airbnb' },
  ]), 820),
});
...
slides.push({
  ...
  build: () => wrap('', `
    <div class="content-pad">
      ...
      <h1 class="title" style="max-width:780px;">Практические примеры вместо абстрактных терминов</h1>
      <ul class="list-plain" style="margin-top:14px;max-width:820px;">
        <li>Разбор этапов разработки продукта на одном сквозном примере от идеи до релиза</li>
        <li>MVP, PoC и product-market fit — с реальными кейсами Uber, Airbnb, eBay и Spotify</li>
        <li>Позиционирование по конкретной структуре, а не общими фразами о продукте</li>
      </ul>
      ${highlightBox('Практично', 'Каждое понятие курса привязано к конкретному примеру или структуре, которую можно сразу использовать в работе.')}
    </div>
  `, highlightCss),
});
...
slides.push({
  ...
  build: () => contentSlide('Как лучше проходить', 'Примеряйте каждое понятие на реальный продукт', `
    <ul class="list-plain" style="margin-top:20px;max-width:820px;font-size:15px;">
      <li>Держите в голове один реальный продукт (свой или известный) и проверяйте на нём каждое понятие курса</li>
      <li>Сформулируйте JTBD и позиционирование для этого продукта по ходу курса</li>
...
slides.push({
  ...
  build: () => recapSlide({
    title: 'В конце курса',
    cards: [
      { heading: 'Модули курса', items: ['Что такое продакт-маркетинг', 'От идеи к MVP', 'Методологии и цикл', 'Go-to-market стратегия', 'Метрики и примеры'] },
      { heading: 'Что получите', items: ['Понимание роли продакт-маркетолога', 'Разбор MVP, PoC и product-market fit', 'Основы позиционирования и go-to-market'] },
      { heading: 'Дальше', text: 'Программа «Интернет-Маркетолог: Старт Карьеры» по CAREERSTART, или платный курс «Профессия продакт-маркетолог».' },
    ],
  }),
});
