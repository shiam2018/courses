...
recording the Loom intro video for course 183103. Run after build.mjs + render_batch.mjs."""
import os
import json
...
out_path = os.path.join(SCRIPT_DIR, 'Sobesedovanie-Loom-prezentaciya.pdf')
