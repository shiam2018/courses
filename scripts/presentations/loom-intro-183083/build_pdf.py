#!/usr/bin/env python3
"""Bundle the rendered slides into one PDF for course 183083's Loom intro video."""
import os
import json
...
out_path = os.path.join(SCRIPT_DIR, 'Prilozhenie-Bez-Koda-Loom-prezentaciya.pdf')
