...
// intro video for course 183100 ("Тимлид в маркетинге: найм, 1-1, мотивация
// команды" — free, standalone course, no funnel). NOT uploaded to Stepik —
  ...
  build: () => {
    ...
    const html = `
      <div class="title-wrap">
        ...
        <h1 class="big" style="color:#fff;">Тимлид в маркетинге: найм, 1-1, мотивация команды</h1>
        <p class="sub">Как устроены процессы в маркетинговой команде — от найма до мотивации, на реальной практике.</p>
      </div>
    `;
    ...
    const html = `
      ...
      <div class="avtor-content">
        ...
        <ul class="list-plain" style="margin-top:12px;font-size:13px;">
          ...
          <li>Каждый день нанимаю, провожу встречи 1-1, читаю стендапы команды</li>
          <li>Курс — на реальных процессах, а не на теории менеджмента</li>
        </ul>
      </div>
    `;
...
slides.push({
  out: 'l03-dlya-kogo',
  build: () => contentSlide('Для кого этот курс', 'И для тимлидов, и для их команды', `
    <ul class="list-plain" style="margin-top:14px;max-width:820px;">
      <li>Для действующих и будущих тимлидов в маркетинге</li>
      <li>Для сотрудников, которые хотят понимать логику своего руководителя</li>
      <li>Бесплатный курс, 2,5-3 часа</li>
...
slides.push({
  out: 'l04-programma',
  build: () => contentSlide('Программа курса', 'От найма до мотивации команды', stepsNum([
    { h: 'Поиск и найм', p: 'Портрет кандидата, собеседование, оффер и испытательный срок' },
    { h: 'Работа с сотрудником', p: 'SMART, делегирование, встречи 1-1, ревью и ИПР, обратная связь' },
    { h: 'Командная коммуникация', p: 'Стендапы в чат, еженедельные синки и отчёты, правила встреч' },
    { h: 'Мотивация', p: 'Виды мотивации и какая подходит какой роли' },
  ]), 820),
});
...
slides.push({
  ...
  build: () => wrap('', `
    <div class="content-pad">
      ...
      <h1 class="title" style="max-width:780px;">Реальные процессы, а не теория менеджмента</h1>
      <ul class="list-plain" style="margin-top:14px;max-width:820px;">
        <li>Форматы стендапов, 1-1 и отчётов — из реальной практики управления командой</li>
        <li>Отдельный взгляд на мотивацию: какая подходит продажам, а какая — креативу и аналитике</li>
        <li>Курс полезен с обеих сторон: и руководителю, и сотруднику</li>
      </ul>
      ${highlightBox('Честно', 'Курс не даёт универсальных рецептов на все случаи — только конкретные форматы и то, почему они работают именно так, а не иначе.')}
    </div>
  `, highlightCss),
});
...
slides.push({
  ...
  build: () => contentSlide('Как лучше проходить', 'Читайте — и пробуйте один процесс за раз', `
    <ul class="list-plain" style="margin-top:20px;max-width:820px;font-size:15px;">
      <li>Не пытайтесь внедрить все процессы сразу — возьмите один и попробуйте на этой неделе</li>
      <li>Сверяйте разбираемые форматы со своим опытом, а не просто читайте</li>
...
slides.push({
  ...
  build: () => recapSlide({
    title: 'В конце курса',
    cards: [
      { heading: 'Модули курса', items: ['Поиск и найм', 'Работа с сотрудником', 'Командная коммуникация', 'Мотивация'] },
      { heading: 'Что получите', items: ['Готовые форматы 1-1, ревью и ИПР', 'Формат ежедневных стендапов и отчётов', 'Понимание, какая мотивация подходит какой роли'] },
      { heading: 'Дальше', text: 'Возьмите один процесс из курса и примените его в своей команде на этой неделе.' },
    ],
  }),
});
