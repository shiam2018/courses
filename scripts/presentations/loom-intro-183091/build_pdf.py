#!/usr/bin/env python3
"""Bundle the rendered slides into one PDF for course 183091's Loom intro video."""
import os
import json
...
out_path = os.path.join(SCRIPT_DIR, 'Kreativnyj-Prodyuser-Loom-prezentaciya.pdf')
